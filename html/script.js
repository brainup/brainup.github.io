...
function selecionarInvestimento(valor, selectedIndex) {
    investimento = valor;
    lista = document.getElementsByClassName("btn");
    for (i = 1; i < lista.length+1; i++) {
        document.getElementById('btn0'+i).style.background = '#AB13B7';
    }
    document.getElementById('btn0'+selectedIndex).style.background = '#160E73';
