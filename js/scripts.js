...
$(document).ready(function(){
   ...
   // Twitter Feed
    ...
    $('form.project-planner').submit(function(e) {

        var thisForm = $(this).closest('form.project-planner'),
            error = 0,
            originalError = thisForm.attr('original-error'),
            loadingSpinner, iFrame, userEmail, userFullName, userFirstName, userLastName, successRedirect;
            // Mailchimp/Campaign Monitor Mail List Form Scripts
        iFrame = $(thisForm).find('iframe.contact-project');
    ...
    $(' form.form-newsletter').submit(function(e) {
        ...
        if ((iFrame.length) && (typeof iFrame.attr('srcdoc') !== "undefined") && (iFrame.attr('srcdoc') !== "")) {
            ...
            if (validateFields(thisForm) !== 1) {
                ...
                iFrame.contents().find('#mce-EMAIL ').attr('value', userEmail);
